...
class Swagger2ControllerWebMvcApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_documentation_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/v2/api-docs',
    ...
    def get_documentation(
        ...
        **kwargs
        ...
        return self.get_documentation_endpoint.call_with_http_info(**kwargs)
