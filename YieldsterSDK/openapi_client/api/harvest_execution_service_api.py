...
class HARVESTEXECUTIONSERVICEApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_harvest_gas_estimate_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/harvest/v2.0/yieldster/get-harvest-gas',
                'operation_id': 'get_harvest_gas_estimate',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_staked_asset_of_a_pool_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/harvest/v2.0/yieldster/get-staking-token-from-stakedcontract',
                'operation_id': 'get_staked_asset_of_a_pool',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_harvest_gas_estimate(
        ...
        **kwargs
        ...
        >>> thread = api.get_harvest_gas_estimate(staking_contract, vault_address, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['vault_address'] = \
            vault_address
        return self.get_harvest_gas_estimate_endpoint.call_with_http_info(**kwargs)
    ...
    def get_staked_asset_of_a_pool(
        self,
        staking_contract,
        **kwargs
    ):
        ...
        >>> thread = api.get_staked_asset_of_a_pool(staking_contract, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['staking_contract'] = \
            staking_contract
        return self.get_staked_asset_of_a_pool_endpoint.call_with_http_info(**kwargs)
    ...
    def harvest_reward(
        ...
        **kwargs
        ...
        >>> thread = api.harvest_reward(vault_address, staking_contract, return_tokens, api_key, async_req=True)
        >>> result = thread.get()
