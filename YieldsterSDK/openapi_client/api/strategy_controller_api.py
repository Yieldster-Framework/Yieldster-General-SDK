...
class StrategyControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_strategies_endpoint = _Endpoint(
            settings={
                'response_type': (Response,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/Strategy/v2.0/yieldster/get',
                'operation_id': 'get_all_strategies',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_all_strategies(
        ...
        **kwargs
        ...
        >>> thread = api.get_all_strategies(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_all_strategies_endpoint.call_with_http_info(**kwargs)
