...
class WhiteList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'user_list': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
            'admin': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            user_list ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
