...
from JavaApi.openapi_client.model.str_bool_date_datetime_dict_float_int_list_str_none_type import StrBoolDateDatetimeDictFloatIntListStrNoneType
...
class ADDTRANSACTIONDETAILSSERVICEApi(object):
    ...
    def get_transaction_by_status(
        ...
        **kwargs
        ...
        >>> thread = api.get_transaction_by_status(async_req=True)
        >>> result = thread.get()
